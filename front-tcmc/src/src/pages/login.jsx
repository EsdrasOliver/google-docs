...
function Login() {
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      {/* {contextHolder} */}
      <div className="flex justify-center items-center bg-gray-100 h-[40rem] w-[50rem] rounded">
          <div className="md:pr-8 md:w-1/2 xl:pr-0 xl:w-5/12 flex flex-col items-center min-w-[60%] gap-8">
            <h1 className="text-3xl text-gray-800 dark:text-gray-800 font-bold md:text-4xl md:leading-tight lg:text-4xl lg:leading-tight">
              Olá, faça o seu login
            </h1>
            <form className="mt-8 w-full flex flex-col items-center" onSubmit={verificyEmail}>
              <div className="w-full lg:w-96 flex flex-col gap-4">
                <div>
                  <label for="email" className="flex start-0 text-sm mb-2 dark:text-white">Email</label>
                ...
                <div>
                  <label for="password" className="flex start-0 text-sm mb-2 dark:text-white">Senha</label>
                  <div className="relative">
                  ...
                  <div className="flex justify-end mt-2">
                    <a className="text-sm text-blue-600 decoration-2 hover:underline font-medium" href="/password">Esqueci minha senha</a>
                  </div>
                </div>
                <div className="flex flex-col items-center">
                  <button type="submit" className="py-3 px-4 w-60 mt-5 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800">Entrar</button>
                </div>
              </div>
            </form>
          </div>
